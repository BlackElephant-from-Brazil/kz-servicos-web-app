...
const inputErrorClass =
  "w-full rounded-lg bg-background border border-danger text-dark placeholder:text-contrast/40 focus:ring-danger focus:ring-1 focus:outline-none px-3 py-2 text-sm font-body";
